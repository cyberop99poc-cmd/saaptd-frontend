        ...
        <div class="bg-gradient-to-r from-red-600 to-red-700 px-8 py-6 flex items-center justify-between">
          <div class="flex-1">
            <div class="flex items-center gap-3">
              <h2 class="text-xl font-bold text-white">🔍 Pengurusan K&KP - Senarai Semak Audit</h2>
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6 flex-shrink-0">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-blue-100 mt-1">Dokumen rujukan K&KP</p>
            </div>
...
const auditId = computed(() => `AUD-KKP-${Date.now()}`)
...
const draftKeyForPhase = (phaseSlug: string) => `kkp_auditScoresDraft_${phaseSlug}`
...
const formType = 'Pengurusan KKP'
const penilaianTypeId = 3
...
const rujukanList = [
  { label: 'A.', title: 'Akta Keselamatan dan Kesihatan Pekerjaan, 1994.' },
  { label: 'B.', title: 'Dasar Keselamatan dan Kesihatan Pekerjaan.' },
  { label: 'C.', title: 'Garis Panduan Pelaksanaan Pengurusan Keselamatan dan Kesihatan Pekerjaan Tentera Darat (K&KP TD), 2006.' },
  { label: 'D.', title: 'Arahan Teknikal Pergerakan, 2023 - Bab 11 - Pengurusan K&KP.' },
  { label: 'E.', title: 'MK TD/G10/10132 (23 Apr 05) - Arahan Pelaksanaan Sistem Pengurusan K&KP Dalam TD.' }
]
...
const auditItems: AuditItem[] = [
  {
    bil: '1',
    perkara: 'Dasar dan Organisasi K&KP',
    isHeader: true,
    subItems: [
      {
        bil: 'a',
        ...
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Dasar K&KP diwujudkan dan ditandatangani oleh Pegawai Memerintah.' },
          { bil: '(2)', perkara: 'Dasar K&KP dimaklumkan kepada semua pekerja.' },
          { bil: '(3)', perkara: 'Dasar K&KP dipamerkan di lokasi strategik.' },
          { bil: '(4)', perkara: 'Dasar K&KP dikemaskini mengikut keperluan semasa.' }
        ]
      },
      {
        bil: 'b',
        perkara: 'Jawatankuasa K&KP:',
        markahPenuh: 0.30,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Jawatankuasa K&KP ditubuhkan mengikut peraturan.' },
          { bil: '(2)', perkara: 'Ahli jawatankuasa meliputi pelbagai peringkat dan jabatan.' },
          { bil: '(3)', perkara: 'Mesyuarat jawatankuasa diadakan sekurang-kurangnya setiap 3 bulan.' },
          { bil: '(4)', perkara: 'Minit mesyuarat disediakan dan disebarkan.' }
        ]
      },
      {
        bil: 'c',
        perkara: 'Pegawai K&KP:',
        markahPenuh: 0.25,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Pegawai K&KP dilantik secara rasmi.' },
          { bil: '(2)', perkara: 'Pegawai K&KP mempunyai kelayakan dan latihan yang sesuai.' },
          { bil: '(3)', perkara: 'Pegawai K&KP diberi masa dan sumber yang mencukupi.' }
        ]
      },
      {
        bil: 'd',
        perkara: 'Komitmen Pengurusan:',
        markahPenuh: 0.20,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Pengurusan menunjukkan komitmen terhadap K&KP.' },
          { bil: '(2)', perkara: 'Peruntukan bajet mencukupi untuk aktiviti K&KP.' },
          { bil: '(3)', perkara: 'Pengurusan menghadiri mesyuarat dan aktiviti K&KP.' }
        ]
      }
    ]
  },
  {
    bil: '2',
    perkara: 'Penilaian Risiko dan Kawalan',
    isHeader: true,
    subItems: [
      {
        bil: 'a',
        perkara: 'Penilaian Risiko (HIRARC):',
        markahPenuh: 0.30,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'HIRARC dijalankan bagi semua aktiviti dan kawasan kerja.' },
          { bil: '(2)', perkara: 'HIRARC dilaksanakan oleh personel terlatih.' },
          { bil: '(3)', perkara: 'Rekod HIRARC lengkap dan mudah diakses.' },
          { bil: '(4)', perkara: 'HIRARC dikemaskini apabila terdapat perubahan.' }
        ]
      },
      {
        bil: 'b',
        perkara: 'Langkah Kawalan Risiko:',
        markahPenuh: 0.35,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Hierarki kawalan risiko dipatuhi (eliminasi, substitusi, engineering, pentadbiran, PPE).' },
          { bil: '(2)', perkara: 'Langkah kawalan dilaksanakan dengan berkesan.' },
          { bil: '(3)', perkara: 'Keberkesanan kawalan dipantau secara berkala.' },
          { bil: '(4)', perkara: 'Tindakan pembetulan diambil terhadap kawalan yang tidak berkesan.' }
        ]
      },
      {
        bil: 'c',
        perkara: 'Pemeriksaan Tempat Kerja:',
        markahPenuh: 0.20,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Pemeriksaan tempat kerja dilakukan secara berkala.' },
          { bil: '(2)', perkara: 'Laporan pemeriksaan disediakan dengan lengkap.' },
          { bil: '(3)', perkara: 'Tindakan susulan terhadap penemuan dilaksanakan.' }
        ]
      },
      {
        bil: 'd',
        ...
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Audit K&KP dalaman dijalankan sekurang-kurangnya setahun sekali.' },
          { bil: '(2)', perkara: 'Laporan audit disediakan dan dibentangkan.' },
          { bil: '(3)', perkara: 'Tindakan pembetulan dan pencegahan dilaksanakan.' }
        ]
      }
    ]
  },
  {
    bil: '3',
    perkara: 'Peralatan Pelindung Diri (PPE)',
    isHeader: true,
    subItems: [
      {
        bil: 'a',
        perkara: 'Penyediaan PPE:',
        markahPenuh: 0.30,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'PPE yang sesuai disediakan untuk semua tugas berisiko.' },
          { bil: '(2)', perkara: 'PPE memenuhi standard yang ditetapkan (MS, CE, ANSI).' },
          { bil: '(3)', perkara: 'Stok PPE mencukupi dan mudah diakses.' },
          { bil: '(4)', perkara: 'PPE disediakan tanpa caj kepada pekerja.' }
        ]
      },
      {
        bil: 'b',
        perkara: 'Penyelenggaraan PPE:',
        markahPenuh: 0.25,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'PPE diperiksa secara berkala untuk kerosakan.' },
          { bil: '(2)', perkara: 'PPE rosak diganti dengan segera.' },
          { bil: '(3)', perkara: 'Kemudahan penyimpanan dan pembersihan PPE disediakan.' },
          { bil: '(4)', perkara: 'Rekod penyelenggaraan PPE diselenggarakan.' }
        ]
      },
      {
        bil: 'c',
        perkara: 'Latihan Penggunaan PPE:',
        markahPenuh: 0.25,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Pekerja dilatih menggunakan PPE dengan betul.' },
          { bil: '(2)', perkara: 'Latihan merangkumi had dan limitasi PPE.' },
          { bil: '(3)', perkara: 'Rekod latihan PPE diselenggarakan.' }
        ]
      },
      {
        bil: 'd',
        perkara: 'Pematuhan Penggunaan PPE:',
        markahPenuh: 0.20,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Pekerja menggunakan PPE semasa menjalankan tugas.' },
          { bil: '(2)', perkara: 'Pemantauan pematuhan PPE dilakukan secara berkala.' },
          { bil: '(3)', perkara: 'Tindakan disiplin terhadap ketidakpatuhan dilaksanakan.' }
        ]
      }
    ]
  },
  {
    bil: '4',
    perkara: 'Pengurusan Kemalangan dan Insiden',
    isHeader: true,
    subItems: [
      {
        bil: 'a',
        perkara: 'Prosedur Pelaporan:',
        markahPenuh: 0.25,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Prosedur pelaporan kemalangan dan insiden diwujudkan.' },
          { bil: '(2)', perkara: 'Semua kemalangan dan insiden dilaporkan dengan segera.' },
          { bil: '(3)', perkara: 'Borang pelaporan lengkap dan mudah digunakan.' }
        ]
      },
      {
        bil: 'b',
        perkara: 'Siasatan Kemalangan:',
        markahPenuh: 0.30,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Semua kemalangan dan insiden diselidik dengan menyeluruh.' },
          { bil: '(2)', perkara: 'Laporan siasatan disediakan dan merangkumi punca akar.' },
          { bil: '(3)', perkara: 'Siasatan dilakukan oleh pasukan terlatih.' },
          { bil: '(4)', perkara: 'Tindakan pembetulan dan pencegahan dikenal pasti.' }
        ]
      },
      {
        bil: 'c',
        ...
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Tindakan pembetulan dilaksanakan dengan segera.' },
          { bil: '(2)', perkara: 'Keberkesanan tindakan pembetulan dipantau.' },
          { bil: '(3)', perkara: 'Pengajaran daripada kemalangan dikongsi kepada semua.' }
        ]
      },
      {
        bil: 'd',
        perkara: 'Statistik dan Analisis:',
        markahPenuh: 0.20,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Statistik kemalangan dan insiden dikumpul dan dianalisis.' },
          { bil: '(2)', perkara: 'Trend kemalangan dikenal pasti dan ditangani.' },
          { bil: '(3)', perkara: 'Laporan statistik dibentangkan kepada pengurusan.' }
        ]
      }
    ]
  },
  {
    bil: '5',
    perkara: 'Kecemasan dan Pertolongan Cemas',
    isHeader: true,
    subItems: [
      {
        bil: 'a',
        perkara: 'Pelan Tindakan Kecemasan:',
        markahPenuh: 0.30,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Pelan tindakan kecemasan disediakan untuk pelbagai senario.' },
          { bil: '(2)', perkara: 'Pelan kecemasan mudah difahami dan diakses.' },
          { bil: '(3)', perkara: 'Pelan kecemasan dikemaskini secara berkala.' },
          { bil: '(4)', perkara: 'Laluan dan pintu kecemasan ditanda dengan jelas.' }
        ]
      },
      {
        bil: 'b',
        perkara: 'Pasukan Tindakan Kecemasan:',
        markahPenuh: 0.25,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Pasukan tindakan kecemasan ditubuhkan dan dilatih.' },
          { bil: '(2)', perkara: 'Ahli pasukan dilengkapi dengan peralatan yang sesuai.' },
          { bil: '(3)', perkara: 'Latihan dan drill kecemasan dijalankan secara berkala.' }
        ]
      },
      {
        bil: 'c',
        perkara: 'Kemudahan Pertolongan Cemas:',
        markahPenuh: 0.25,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Kotak pertolongan cemas disediakan di lokasi strategik.' },
          { bil: '(2)', perkara: 'Kandungan kotak pertolongan cemas lengkap dan tidak luput.' },
          { bil: '(3)', perkara: 'Pekerja terlatih dalam pertolongan cemas asas.' },
          { bil: '(4)', perkara: 'Nombor kecemasan dipamerkan dengan jelas.' }
        ]
      },
      {
        bil: 'd',
        perkara: 'Drill Kecemasan:',
        markahPenuh: 0.20,
        isSubHeader: true,
        subItems: [
          { bil: '(1)', perkara: 'Drill kebakaran dijalankan sekurang-kurangnya dua kali setahun.' },
          { bil: '(2)', perkara: 'Laporan drill disediakan dengan penemuan dan penambahbaikan.' },
          { bil: '(3)', perkara: 'Tindakan susulan drill dilaksanakan.' }
        ]
      }
    ]
  }
